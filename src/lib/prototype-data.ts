...
export const workObjects: WorkObject[] = [
  ...
  { id: "obj_sales_summary", area: "Pipeline", type: "status_report", typeLabel: "Weekly Summary", department: "sales", title: "Sales — Weekly Summary", statusLabel: "Queue", statusKind: "neutral", owner: "Jo from Sales Team Lead", preview: "4 active prospects, 2 awaiting approval." },
  ...
  { id: "obj_mkt_blog", type: "content_draft", typeLabel: "Content Draft", department: "marketing", title: "Blog — \"Operating workspace, not another dashboard\"", statusLabel: "Queue", statusKind: "neutral", owner: "Jo from Marketing IC", preview: "Long-form draft ready for first edit." },
  { id: "obj_mkt_campaign", type: "campaign", typeLabel: "Campaign", department: "marketing", title: "Q3 Demand — Field Services", statusLabel: "Queue", statusKind: "scheduled", owner: "Jo from Marketing Team Lead", preview: "3-week sequence targeting field-service operators.", meta: [{ label: "Channels", value: "LinkedIn, email, search" }] },
...
export const queueActions: QueueAction[] = [
  ...
  { id: "act_006", title: "Research Northwind Logistics", department: "sales", status: "queued", sourceObjectId: "obj_sales_north", updatedAt: "5m ago", step: "Queue", nextOutput: "Research Brief" },
  { id: "act_007", title: "Draft Q3 demand campaign", department: "marketing", status: "queued", updatedAt: "20m ago", step: "Queue", nextOutput: "Campaign plan" },
...
export const outputs: OutputRecord[] = [
  { id: "out_001", title: "Acme Manufacturing — Research Brief", type: "Research Brief", department: "sales", generatedBy: "Jo from Sales IC", statusKind: "done", statusLabel: "Done", timestamp: "Today, 9:14 AM", history: ["Queue", "Active", "Done"], summary: "Profile, 3 buying signals, and a speed-to-quote angle.", sourceObjectId: "obj_sales_brief_acme" },
  { id: "out_002", title: "Weekly Client Status — Square One Foundry", type: "Status Report", department: "operations", generatedBy: "Jo from Operations Team Lead", statusKind: "attention", statusLabel: "Blocked", timestamp: "Today, 8:02 AM", history: ["Queue", "Active", "Blocked"], summary: "On track — 2 deliverables shipped, 1 in progress.", sourceObjectId: "obj_ops_status" },
  { id: "out_003", title: "LinkedIn post — Friday", type: "Content Draft", department: "marketing", generatedBy: "Jo from Marketing Team Lead", statusKind: "attention", statusLabel: "Blocked", timestamp: "Yesterday, 4:30 PM", history: ["Queue", "Blocked"], summary: "Short post on Human + Machine work for SMBs.", sourceObjectId: "obj_mkt_li" },
  { id: "out_004", title: "Invoice — Square One Foundry", type: "Invoice", department: "finance", generatedBy: "Jo from Finance Team Lead", statusKind: "attention", statusLabel: "Blocked", timestamp: "Yesterday, 2:10 PM", history: ["Queue", "Active", "Blocked"], summary: "$4,500 monthly engagement fee, 2 line items.", sourceObjectId: "obj_fin_inv_foundry" },
  { id: "out_005", title: "Square One Foundry — SOW", type: "Contract Draft", department: "legal", generatedBy: "Jo from Legal Team Lead", statusKind: "attention", statusLabel: "Blocked", timestamp: "Yesterday, 11:45 AM", history: ["Queue", "Blocked"], summary: "Scope, deliverables, and term drafted for sign-off.", sourceObjectId: "obj_legal_sow" },
  { id: "out_006", title: "Cedar Valley Roofing — Quote Package", type: "Quote Package", department: "sales", generatedBy: "Jo from Risk Lead", statusKind: "attention", statusLabel: "Blocked", timestamp: "Yesterday, 9:20 AM", history: ["Queue", "Active", "Blocked"], summary: "Two-carrier comparison; recommended option closes a GL gap.", sourceObjectId: "obj_risk_quote" },
  { id: "out_007", title: "Sprint 0 — Stabilization", type: "Sprint Record", department: "technology", generatedBy: "Jo from Technology Team Lead", statusKind: "in_progress", statusLabel: "Active", timestamp: "Mon, 10:00 AM", history: ["Queue", "Active"], summary: "5 stabilization items tracked this sprint.", sourceObjectId: "obj_tech_sprint" },
];
